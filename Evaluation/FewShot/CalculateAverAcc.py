...
for file_name in os.listdir("./results_fewshot_avg/"):
    ...
    f = open(f"./results_fewshot_avg/{file_name}")
    data = json.load(f)
    f.close()
...
with open("./merged_results_FewShot_Avg-3-Runs.json", 'w') as f:
...
with open("./averaged_results_FewShot_Avg-3-Runs.json", 'w') as f:
    json.dump(averaged_results, f, indent=4)

# with open("./std_deviation_results_FewShot-SFT-V2_Avg-3-Runs.json", 'w') as f:
with open("./std_deviation_results_FewShot_Avg-3-Runs.json", 'w') as f:
