...
```{r}
# load files
filenames <- list.files("../../results_TruthfulQA/", recursive = TRUE, full.names = TRUE, pattern = '.csv$')

filenames


filenames_truth <- list.files("../../results_TruthfulQA_fulltruth/", recursive = TRUE, full.names = TRUE, pattern = '.csv$')
