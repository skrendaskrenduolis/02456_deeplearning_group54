...
def get_correct_answer(row):
    ...
    correct_index = np.argmax(labels)
...
def generate_classes(row):
    labels_length = len(row['mc1_targets']['labels'])
...
print(merged_df["formatted_question_choices"].head())
print(merged_df_truthful.shape)
print(merged_df_truthful["formatted_question_choices_truth"].head())
