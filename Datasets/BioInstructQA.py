...
os.environ["HF_DATASETS_CACHE"] = "/dtu/blackhole/0d/214285/datasets"
...
def getPrompt(ctx, qst, answ_chs, crt_answ, few_shot_examples=None):
    ...
    def parseElement(context, question, answer_choices, correct_answer_letter):
        ...
        answer_choices = " \n ".join(
            [f"({a['letter'].upper()}) {a['text']}" for a in answer_choices]
        )
        ...
        return (
            "{{context}}**Question:** {{question}} \n {{answer_choices}} \n **Answer:**({{correct_answer_letter}}".replace(
                "{{context}}", context
            )
    ...
    if few_shot_examples == None:
        ...
        for fe in few_shot_examples:
            ...
            fse = parseElement(
                fe["context"],
                fe["question"],
                [{"letter": o, "text": fe["options"][o]} for o in fe["options"]],
                fe["correct_answer_letter"],
            )
            # print(fse)
...
def getPromptChat(ctx, qst, answ_chs, crt_answ, few_shot_examples=None):
    ...
    def parseElement(context, question, answer_choices, correct_answer_letter):
        ...
        return [
            {
                "role": "user",
                "content": "{{context}}**Question:** {{question}} {{answer_choices}}".replace(
                    "{{context}}", context
                )
                .replace("{{question}}", question)
                .replace("{{answer_choices}}", answer_choices),
            ...
            {
                "role": "assistant",
                "content": "**Answer:**({{correct_answer_letter}}".replace(
            ...
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./base/overall_train+prompt.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./base/overall_validation+prompt.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "split_name": "test",
                    "filepath": os.path.join(
                        data_dir, "./base/overall_test+prompt.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./langs_processed/French-full.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./langs_processed/Chinese-full.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./langs_processed/Arabic-full.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./langs_processed/German-full.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./langs_processed/Portuguese-full.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./langs_processed/Russian-full.json"
                    ),
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    ...
                    "filepath": os.path.join(
                        data_dir, "./langs_processed/Spanish-full.json"
                    ),
                },
            ),
        ]
